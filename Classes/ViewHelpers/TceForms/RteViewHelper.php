 ...
 * <textarea id="RTEareatx_myext_pi1[myRteTextArea]_1" name="tx_myext_pi1[myRteTextArea]" style="position:relative;
 * left:0px; top:0px; height:380px; width:460px; border: 1px solid black;">This is shown inside the textarea</textarea>
 *
 * @package    Fluid
...
class RteViewHelper extends AbstractFormFieldViewHelper {
    ...
    /**
     * "special" configuration - what is found at position 4 in the types configuration of a field from record, parsed
     * into an array.
     *
     * @var array
     */
    ...
    protected function addRteJsToViewHelperVariableContainer() {
        ...
        $rte[] = array(
            'pre'    => $this->additionalJS_pre_complete,
